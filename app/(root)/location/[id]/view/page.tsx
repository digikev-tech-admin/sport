        ...
        <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="border-t pt-6">
              ...
              <div className="text-gray-700 leading-relaxed whitespace-pre-wrap flex flex-wrap gap-2">
                {location.facilities?.map((facility, index) => (
                  <div key={index} className="bg-purple-100 rounded-full px-2 py-1 text-sm">
                    {facility}
                  </div>
                ))}
              </div>
